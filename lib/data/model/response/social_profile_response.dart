...
SocialProfileResponse socialProfileResponseFromJson(String str) =>
    SocialProfileResponse.fromJson(json.decode(str));

String socialProfileResponseToJson(SocialProfileResponse data) =>
...
class SocialProfileResponse {
  ...
  factory SocialProfileResponse.fromJson(Map<String, dynamic> json) =>
      SocialProfileResponse(
        code: json["code"],
