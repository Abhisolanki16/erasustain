...
import 'package:Erasustain/core/exceptions/dio_exception_util.dart';
...
import '../../../../data/model/response/log_out_response.dart';
...
abstract class _AuthStoreBase with Store {
  ...
  Future logout() async {
    try {
      errorMessage = null;
      var commonStoreFuture = authRepo.logout();
